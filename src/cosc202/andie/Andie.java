...
public class Andie {
    ...
    private static void createAndShowGUI() throws Exception {
        ...
        // Creates and adds the macro options menu
        // dont comment this out g, i kinda need it here lol
         MacroActions macroActions = new MacroActions();
         menuBar.add(macroActions.CreateMenu());

        // please do not comment this code out and push it
        PaintingActions paintingActions = new PaintingActions();
        menuBar.add(paintingActions.createJMenu(imagePanel));

        // Creates and adds the toolbar to the frame
        Toolbar toolbarPanel = new Toolbar();
        frame.add(toolbarPanel.get(), BorderLayout.NORTH);
